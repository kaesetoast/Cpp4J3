...
int main()
{
    ...
    // Copy-Konstruktor, Zuweisung und == Operator
    Pair<int, float> i_f3 = Pair<int, float> (i_f);
    ...
    assert(greaterInt(2,3) == false);
    assert(greaterInt(3,2) == true);

    Greater<string> greaterString;
    assert(greaterString("AB", "AAA") == true);
